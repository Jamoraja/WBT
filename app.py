...
# Input fields
temp_celsius = st.number_input("Air Temperature (°C)", min_value=-50.0, max_value=60.0, value=30.0, step=0.1)
rel_humidity = st.number_input("Relative Humidity (%)", min_value=0.0, max_value=100.0, value=60.0, step=0.1)
